...
> Cập nhật: 24/07/2026 · App **v3.42.2** · Apps Script **v3.24.2** · SQL đã chạy tới **130**
...
- Dữ liệu bán hàng KHÔNG có giờ: `dateISO_` trong Apps Script cắt về `yyyy-MM-dd` ngay
  khi nạp. Vì vậy không so được nửa ngày hôm nay với cùng giờ tuần trước — thẻ Bán hôm
  nay chỉ hiện số thật của cùng thứ tuần trước, không tính phần trăm.
