...
> Cập nhật: 24/07/2026 · App **v3.42.0** · Apps Script **v3.24.2** · SQL đã chạy tới **130**
...
- Lớp phủ hộp thoại: dùng component `LopPhu` trong Dashboard — style gắn thẳng vào thẻ,
  ...
  xem `.tq-anh-full img` cũng nền trắng bo góc. Card mã mới `.mm-o`: tên sản phẩm trước,
  Ra mắt/Tồn kho·Tồn CH/Đang có ở N CH xuống hàng, bấm card mở phân bổ theo cửa hàng.
