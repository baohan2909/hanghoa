...
> Cập nhật: 24/07/2026 · App **v3.41.1** · Apps Script **v3.24.2** · SQL đã chạy tới **129**
...
- Lớp phủ hộp thoại là `.modal-bg` (fixed, nền tối); `.modal` chỉ là hộp trắng bên trong.
  Dùng `.modal` làm lớp phủ thì hộp rơi vào luồng trang, mất nền, vỡ bố cục.
